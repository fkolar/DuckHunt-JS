...
export class Game {
  ...
  gameElement() {
    return this.ge ? this.ge : document.body;
  }


  onLoad() {
    this.gameElement().appendChild(this.renderer.view);
  ...
  addFullscreenLink() {
    ...
    this.stage.hud.fullscreenLink = 'fullscreen';
  }
  ...
  bindEvents() {
    ...
    this.gameElement().addEventListener('keypress', (event) => {
    ...
    this.gameElement().addEventListener('fullscreenchange', () => {
      if (document.fullscreenElement) {
        this.stage.hud.fullscreenLink = 'unfullscreen';
      } else {
        this.stage.hud.fullscreenLink = 'fullscreen';
      }
    });
  ...
  fullscreen() {
    ...
    utils.toggleFullscreen(this.gameElement());
  }
  ...
  registerOnScoreChange(handler) {
    this.scoreChange = handler;
  }
